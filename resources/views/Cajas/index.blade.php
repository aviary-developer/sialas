...
<div class="launcher">
  ...
  <div class="tooltip">
    <a href={!! asset('/cajas?nombre='.$name.'&estado='.$cam) !!}>
      @if(!$cam)
...
<div class="panel">
  <div class="enc">
    ...
    @endif
    <div class="sep"></div>
    {!!Form::open(['route'=>'cajas.index','method'=>'GET','role'=>'search','class'=>'search'])!!}
    {!! Form::text('nombre',null,['placeholder'=>'Nombre de caja']) !!}
    {!! Form::submit('Buscar') !!}
    {!! Form::close() !!}
  </div>
  <center>
